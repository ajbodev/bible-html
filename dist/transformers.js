...
// OJ
exports.ls = new Transformer({
  name: 'ls',
  engines: ['LiveScript'],// `.` means "no dependency"
  outputFormat: 'js',
  sync: function (str, options) {
    options.bare = true;
    return this.cache(options) || this.cache(options, this.engine.compile(str, options));
...
exports.__ = new Transformer({
  name: '__',
  engines: ['.'],
  outputFormat: 'html',
  sync: function (str) { return str; }
});

exports.jadejs = new Transformer({
  name: 'jadejs',
  engines: ['jade'],
  outputFormat: 'js',
  sync: function (str, options) {
    options.bare = true;
    return this.cache(options) || this.cache(options, this.engine.compileClient(str, options));
  }
});

exports.react = new Transformer({
  name: 'react',
  engines: ['react-jade'],
  outputFormat: 'js',
  sync: function (str, options) {
